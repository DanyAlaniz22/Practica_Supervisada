...
if(!empty ($_POST['BotonLogin'])){
  ...
  if(!empty($UsuarioLogueado)){
      ...
      if($UsuarioLogueado['ACTIVO'] == 0){
        ...
        require_once 'funciones/actualizacionLogin.php';
        $ActualizaFechaHora=ActualizarFecha_UltimoAcceso($_SESSION['Usuario_Id'], $_SESSION['UltimaFechaAcceso'],  $MiConexion);
